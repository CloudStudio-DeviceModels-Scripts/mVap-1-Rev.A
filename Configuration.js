...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("RELATIVE_HUMIDITY ", "RELATIVE_HUMIDITY ", endpointType.humiditySensor);
    endpoints.addEndpoint("TEMPERATURE", "TEMPERATURE", endpointType.temperatureSensor);
    endpoints.addEndpoint("ATMOSPHERIC_PRESSURE", "ATMOSPHERIC_PRESSURE", endpointType.pressureSensor); //hPa
    endpoints.addEndpoint("RAINFALL_INTENSITY ", "RAINFALL_INTENSITY ", endpointType.genericSensor)
        .variableTypeId = 1014;
    endpoints.addEndpoint("RAIN_PRECIPITATION ", "RAIN_PRECIPITATION ", endpointType.genericSensor)
        .variableTypeId = 1015;
    endpoints.addEndpoint("WIND_SPEED ", "WIND_SPEED ", endpointType.genericSensor)
        .variableTypeId = 1013;
    endpoints.addEndpoint("WIND_DIRECTION ", "WIND_DIRECTION ", endpointType.genericSensor)
        .variableTypeId = 1020;
    endpoints.addEndpoint("SOLAR_IRRADIANCE ", "SOLAR_IRRADIANCE ", endpointType.genericSensor)
        .variableTypeId = 1016;
    endpoints.addEndpoint("EVAPORATED_LEVEL ", "EVAPORATED_LEVEL ", endpointType.genericSensor)
        .variableTypeId = 1021;
    endpoints.addEndpoint("TANK_LEVEL ", "TANK_LEVEL ", endpointType.genericSensor)
        .variableTypeId = 1021;
    endpoints.addEndpoint("LIQUID_TEMPERATURE", "LIQUID_TEMPERATURE", endpointType.temperatureSensor);
    endpoints.addEndpoint("MAX_LEVEL ", "MAX_LEVEL ", endpointType.genericSensor)
        .variableTypeId = 1021;
    endpoints.addEndpoint("TIME_BEETWEN_FILLS ", "TIME_BEETWEN_FILLS ", endpointType.genericSensor)
        .variableTypeId = 1022;
    endpoints.addEndpoint("LIQUID_DENSITY ", "LIQUID_DENSITY ", endpointType.genericSensor)
        .variableTypeId = 1017;
    endpoints.addEndpoint("LIQUID_CONDUCTIVITY ", "LIQUID_CONDUCTIVITY ", endpointType.genericSensor)
        .variableTypeId = 1018;
    endpoints.addEndpoint("CB", "CB", endpointType.voltageSensor );
    endpoints.addEndpoint("V1_STATUS ", "V1_STATUS ", endpointType.genericSensor)
        .variableTypeId = 1025;
    endpoints.addEndpoint("A_EMPTY_TANK ", "A_EMPTY_TANK ", endpointType.genericSensor)
        .variableTypeId = 1023;
    endpoints.addEndpoint("A_CB_LOW_VOLTAGE ", "A_CB_LOW_VOLTAGE ", endpointType.genericSensor)
        .variableTypeId = 1023;
    endpoints.addEndpoint("A_SENSOR_DISCONNECTED ", "A_SENSOR_DISCONNECTED ", endpointType.genericSensor)
        .variableTypeId = 1023;
